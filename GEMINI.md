# Slide Creation Guide - Gemini CLI
...
## Interaction Examples with Gemini CLI
...
## Gemini CLI Operating Principles

Principles for Gemini CLI when supporting slide creation:
